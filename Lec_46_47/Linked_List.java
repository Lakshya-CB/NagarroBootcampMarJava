...
//			Pop node  and join them at the end of the new Linked List
	...
	public void make_LL_test_Cyclic() {
		Node n1 = new Node(1);
		Node n2 = new Node(2);
		Node n3 = new Node(3);
		Node n4 = new Node(4);
...
//		Now your fast and slow are inseide the cycle and pointing to the same node
...
//		P 3 : Car 1 and Car 2 Size apart  
		Node Car1 = head;
		...
		Node Car2 = head;
//		P 4 : Run them at same speed, wait just before crash crash 
		while (Car1.next != Car2.next) {

			Car1 = Car1.next;
			Car2 = Car2.next;
			System.out.println(Car1.data + " : " + Car2.data);
		}
		
//		Car 1 is at the last node of the Cycle,, break
		Car1.next = null;

		return;

	}
	public void Break_Cycle2() {
//		P 1 
		Node fast = head;
		Node slow = head;
		while (fast != null && fast.next != null) {
